...
namespace Morpheus {
	...
	VulkanValidation::~VulkanValidation()
	{
		DestroyDebugMessenger(VulkanInstance::GetInstance()->GetVulkan(), m_DebugMessenger, nullptr);
	}
	...
	void VulkanValidation::SetupDebugMessenger()
	{
		...
		VkResult result = CreateDebugMessenger(VulkanInstance::GetInstance()->GetVulkan(), &createInfo, nullptr, &m_DebugMessenger);
